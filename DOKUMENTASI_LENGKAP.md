...
* **Hasil Output**: Berkas installer executable akan disimpan di folder `/dist-electron/AGS Techflow Setup [versi].exe` (misalnya: `AGS Techflow Setup 1.0.1.exe`). File inilah yang didistribusikan kepada pengguna akhir.
